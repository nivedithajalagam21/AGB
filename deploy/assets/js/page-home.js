...
if (root) {
  ...
  const exploreCards = [
    { title: "Methodology", body: "Understand the attack formulation, orbit reasoning, and GOV pipeline.", href: "index.html" },
    { title: "Models", body: "Review victim architectures and why topology perturbations transfer across them.", href: "models.html" },
    { title: "Datasets", body: "Inspect benchmark graph characteristics and homophily-driven attack behavior.", href: "datasets.html" },
    { title: "Results", body: "Analyze standardized performance, efficiency, and cross-model attack strength.", href: "results.html" },
    { title: "Leaderboard", body: "Compare adversarial attack performance across datasets and models.", href: "leaderboard.html" }
  ];
  ...
  root.innerHTML = `
    ...
    ${sectionWrapper({
      ...
      content: `
        ...
        <div class="agb-link-row">
          <a class="btn btn-primary" href="index.html">Explore Method</a>
          <a class="btn btn-default" href="leaderboard.html">View Leaderboard</a>
        </div>
      `
    })}
    ${sectionWrapper({
    ...
    ${sectionWrapper({
      ...
      content: `
        ...
        <div class="agb-link-row">
          <a class="btn btn-primary" href="index.html">Methodology</a>
          <a class="btn btn-default" href="models.html">Models</a>
          <a class="btn btn-default" href="datasets.html">Datasets</a>
          <a class="btn btn-default" href="results.html">Results</a>
          <a class="btn btn-default" href="leaderboard.html">Leaderboard</a>
